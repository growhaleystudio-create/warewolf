...
export function RoleIllustration({
  ...
  // Specific custom artwork for Werewolf generated by AI
  if (role === "WEREWOLF" && !imgError) {
    return (
      <div
        className={`relative rounded-3xl overflow-hidden shadow-2xl border-2 border-amber-500/60 group ${sizeClasses} ${className}`}
      >
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/roles/werewolf.jpg"
          alt="Werewolf Alpha Illustration"
  ...
  // High-Detail Dark Fantasy Vector Tarot Card Artworks for all Roles
  return (
    <div
